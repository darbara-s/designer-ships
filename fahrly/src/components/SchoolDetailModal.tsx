      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto relative">
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="flex flex-col gap-3 pt-2">
            <h3 className="text-sm font-bold text-gray-500 uppercase tracking-wider">Contact This School</h3>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center gap-2 bg-[#25D366] hover:bg-[#1ebe5d] text-white font-bold py-3 px-6 rounded-full transition-colors"
            >
              <Zap size={18} />
            ...
            <div className="grid grid-cols-2 gap-3">
              <a
                href="tel:+4930000000"
                className="flex items-center justify-center gap-2 border border-gray-200 hover:border-gray-300 hover:bg-gray-50 text-gray-700 font-semibold py-2.5 px-4 rounded-full transition-colors text-sm"
              >
                <Phone size={16} />
                Call School
              </a>
